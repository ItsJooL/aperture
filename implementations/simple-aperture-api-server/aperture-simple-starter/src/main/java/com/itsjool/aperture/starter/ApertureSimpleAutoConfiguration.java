...
public class ApertureSimpleAutoConfiguration {
    ...
    @Bean
    public com.itsjool.aperture.runtime.audit.AuditBridge auditBridge(com.itsjool.aperture.spi.AuditWriter auditWriter) {
        return new com.itsjool.aperture.runtime.audit.AuditBridge(auditWriter);
    }
